...
class Suggestions extends Component {
	...
	suggestionsCount = () => this.props.suggestions.length
	...
	increasePosition = () => this.setState( {
		suggestionPosition: ( this.state.suggestionPosition + 1 ) % this.suggestionsCount(),
	} )

	decreasePosition = () => this.setState( {
		suggestionPosition: ( this.suggestionsCount() + this.state.suggestionPosition - 1 ) % this.suggestionsCount(),
	} )
	...
	render() {
		...
		const showSuggestions = this.suggestionsCount() > 0;
			...
			<div>
				{
					...
					<div className="suggestions__wrapper">
						{ map( this.props.suggestions, ( { label }, idx ) => (
							<Item
								key={ idx }
